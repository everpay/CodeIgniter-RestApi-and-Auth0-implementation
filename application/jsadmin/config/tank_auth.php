...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Jeanstrip';
$config['webmaster_email'] = 'umair.ali@logicpowered.net';
...
$config['firstname_max_length'] = 20;
$config['lastname_min_length'] = 2;
$config['lastname_max_length'] = 20;
